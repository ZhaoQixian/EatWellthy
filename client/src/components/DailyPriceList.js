  ...
  const supermarkets = [
    {
      ...
      description: "Wide range of healthy options and organic produce at budget-friendly prices.",
      logo: fairpriceLogo,
      isClickable: true
    },
    {
      ...
      name: "Giant",
      url: "https://giant.sg/",
      description: "Fresh fruits, vegetables, and lean proteins at great value prices.",
      logo: giantLogo,
      isClickable: true
    },
    {
      ...
      description: "Premium selection of organic produce and specialty health foods.",
    ...
    },
    {
      ...
      description: "Fresh produce and healthy Asian ingredients at competitive prices.",
      logo: shengsiongLogo,
      isClickable: true
    },
    {
    ...
    <div className="showcase-container">
      <div className="showcase-content">
        ...
        <div className="showcase-header">
          ...
          <p>Find all your healthy ingredients at these trusted supermarkets.</p>
          <p>Each store offers quality products to support your wellness journey.</p>
        </div>
        ...
        <div className="showcase-footer">
          <p>Visit store websites for current promotions on healthy products and fresh ingredients.</p>
        </div>
      </div>
    </div>
  );
