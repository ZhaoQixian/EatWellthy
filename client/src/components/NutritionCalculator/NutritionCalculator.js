...
const NutritionCalculator = () => {
  ...
  const add_nutrition_infor2 = useCallback(async (dispatch) => {
  ...
  return (
    ...
    >
      ...
      <div id="food_meal_forms">
        {formType === "addFood" && (
          <div className="add_food_form">
            <form id="add_food_form" onSubmit={add_nutrition_infor2}>
              <h3>
                Provide the following data for your food to add it to the
                registry:
              </h3>
              <p>
                Name:{" "}
              ...
              <p>
                ...
                <input
                  type="text"
                  id="food_measurement_unit"
                  autoComplete="off"
                />
              </p>
              <p>
                Serving Size:{" "}
                <input type="text" id="food_serving_size" autoComplete="off" />
              </p>
              <p>
                Energy (in kcal):{" "}
                <input type="text" id="food_energy" autoComplete="off" />
              </p>
              <p>
                Fat (in grams):{" "}
                <input type="text" id="food_fat" autoComplete="off" />
              </p>
              <p>
                Sugar (in grams):{" "}
                <input type="text" id="food_sugar" autoComplete="off" />
              </p>
              <p>
                Fiber (in grams):{" "}
                <input type="text" id="food_fiber" autoComplete="off" />
              </p>
              <p>
                Protein (in grams):{" "}
                <input type="text" id="food_protein" autoComplete="off" />
              </p>
              <p>
                Sodium (in milligrams):{" "}
                <input type="text" id="food_sodium" autoComplete="off" />
              </p>
              <p>
                Vitamin_c (in milligrams):{" "}
                <input type="text" id="food_vc" autoComplete="off" />
              </p>
              <p>
                Calcium (in milligrams):{" "}
                <input type="text" id="food_calcium" autoComplete="off" />
              </p>
              <p>
                Iron (in milligrams):{" "}
                <input type="text" id="food_iron" autoComplete="off" />
              </p>
              ...
              <div className="add_food_bottom_buttons">
                <button
                  className="submit"
                  type="submit"
                  onClick={add_nutrition_infor2}
                >
                  Submit
                </button>
                <button className="quit" type="reset">
                  Quit
                </button>
              </div>
            </form>
        ...
        {formType === "addMeal" && <MealForm username={username} />}

        {formType === "remove" && <FoodStored />}
      </div>
    </div>
  );
};
